...
export const footerInfo = [
    {icon:logo, info1: 'Tufcret Construction', id: 1},
    {icon: faMobileAlt, info1: '+91 9970615385', info2: 'subhash.mandhan@gmail.com', id: 2},
    {icon: faMapMarkedAlt, info1: 'abc', info2: 'Jaripatka,Nagpur', id: 3}
];